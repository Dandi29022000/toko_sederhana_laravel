...
class SlideController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.package.slides.index', compact('slides'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.package.slides.create', compact('statuses'));
    }
    ...
    public function edit(Slide $slide)
    {
		...
		return view('admin.package.slides.edit', compact('slide', 'statuses'));
    }
